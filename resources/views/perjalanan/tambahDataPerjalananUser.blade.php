                ...
                <div class="card-body">
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            ...
                            name="lampusen_depan" value="berfungsi" id="lsd" autocomplete="off" />
                            <label class="btn btn-outline-success" for="lsd">Berfungsi</label>

                            <input type="radio" class="btn-check"
                            name="lampusen_depan" value="tidak berfungsi" id="lsd0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="lampusen_belakang" value="berfungsi" id="lsb" autocomplete="off" />
                            <label class="btn btn-outline-success" for="lsb">Berfungsi</label>

                            <input type="radio" class="btn-check" name="lampusen_belakang" value="tidak berfungsi" id="lsb0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="lampu_rem" value="berfungsi" id="lr" autocomplete="off" />
                            <label class="btn btn-outline-success" for="lr">Berfungsi</label>

                            <input type="radio" class="btn-check" name="lampu_rem" value="tidak berfungsi" id="lr0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="lampu_mundur" value="berfungsi" id="lm" autocomplete="off" />
                            <label class="btn btn-outline-success" for="lm">Berfungsi</label>

                            <input type="radio" class="btn-check" name="lampu_mundur" value="tidak berfungsi" id="lm0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="body" value="baik" id="bdy" autocomplete="off" />
                            <label class="btn btn-outline-success" for="bdy">Baik</label>

                            <input type="radio" class="btn-check" name="body" value="rusak" id="bdy0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="ban" value="baik" id="ban" autocomplete="off" />
                            <label class="btn btn-outline-success" for="ban">Baik</label>

                            <input type="radio" class="btn-check" name="ban" value="rusak" id="ban0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="klakson" value="baik" id="klak" autocomplete="off" />
                            <label class="btn btn-outline-success" for="klak">Baik</label>

                            <input type="radio" class="btn-check" name="klakson" value="rusak" id="klak0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="pedal_gas" value="berfungsi" id="pgas" autocomplete="off" />
                            <label class="btn btn-outline-success" for="pgas">Berfungsi</label>

                            <input type="radio" class="btn-check" name="pedal_gas" value="rusak" id="pgas0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="pedal_kopling" value="berfungsi" id="pkop" autocomplete="off" />
                            <label class="btn btn-outline-success" for="pkop">Berfungsi</label>

                            <input type="radio" class="btn-check" name="pedal_kopling" value="rusak" id="pkop0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="pedal_rem" value="berfungsi" id="prem" autocomplete="off" />
                            <label class="btn btn-outline-success" for="prem">Berfungsi</label>

                            <input type="radio" class="btn-check" name="pedal_rem" value="rusak" id="prem0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="weaper" value="berfungsi" id="weap" autocomplete="off" />
                            <label class="btn btn-outline-success" for="weap">Berfungsi</label>

                            <input type="radio" class="btn-check" name="weaper" value="rusak" id="weap0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="air_weaper" value="terisi" id="airw" autocomplete="off" />
                            <label class="btn btn-outline-success" for="airw">Terisi</label>

                            <input type="radio" class="btn-check" name="air_weaper" value="tidak terisi" id="airw0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="air_radiator" value="terisi" id="airr" autocomplete="off" />
                            <label class="btn btn-outline-success" for="airr">Terisi</label>

                            <input type="radio" class="btn-check" name="air_radiator" value="tidak terisi" id="airr0" autocomplete="off" />
                    ...
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-lg-8 col-sm-10 btn-group">
                            <input type="radio" class="btn-check" name="oli_mesin" value="terisi" id="oli" autocomplete="off" />
                            <label class="btn btn-outline-success" for="oli">Terisi</label>

                            <input type="radio" class="btn-check" name="oli_mesin" value="tidak terisi" id="oli0" autocomplete="off" />
