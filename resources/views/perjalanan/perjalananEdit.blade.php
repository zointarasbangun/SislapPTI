...
@section('content')
    ...
    <section class="content-wrapper">
        ...
        @endif
        <!-- Data Perjalanan -->
        <form method="POST" action="{{ route('statusPerjalananUser.update', $perjalanan->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 mb-4">
                                ...
                                <input type="date" name="tgl_perjalanan" id="tanggal" class="form-control" value="{{ old('tgl_perjalanan', $perjalanan->tgl_perjalanan ?? '') }}" />
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-4">
                                ...
                                <input type="text" name="alamat_awal" id="alamatawal" class="form-control"
                                       placeholder="Lokasi Saya Saat Ini" value="{{ old('alamat_awal', $perjalanan->alamat_awal ?? '') }}" />
                            </div>

                            <div class="col-lg-6 col-sm-12 mb-4">
                                <label class="form-label" for="alamatujuan">Alamat Tujuan</label>
                                <input type="text" name="alamat_tujuan" id="alamatujuan" class="form-control" value="{{ old('alamat_tujuan', $perjalanan->alamat_tujuan ?? '') }}" />
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-4">
                            ...
                            <div class="col-lg-6 col-sm-12 mb-4">
                                ...
                                <input type="number" name="km_akhir" id="kmakhir" class="form-control" value="{{ old('km_akhir', $perjalanan->km_akhir ?? '') }}"/>
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-4">
                            ...
                            <div class="col-lg-12 col-sm-12 mb-4 dropdown">
                                <div id="jenisperjalanan">
                                    ...
                                    <select id="jperjalananSelect" name="jenis_perjalanan" class="form-control select" style="display: inline;">
                                        ...
                                        <option value="perjalanan luar" {{ (old('jenis_perjalanan', $perjalanan->jenis_perjalanan ?? '') == 'perjalanan luar') ? 'selected' : '' }}>
                                            Perjalanan Luar
                                        </option>
                                        <option value="perjalanan dalam" {{ (old('jenis_perjalanan', $perjalanan->jenis_perjalanan ?? '') == 'perjalanan dalam') ? 'selected' : '' }}>
                                            Perjalanan Dalam
                                        </option>
                                    </select>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="lampu_depan" value="berfungsi" id="ld" autocomplete="off"
                                    {{ (old('lampu_depan', $perjalanan->lampu_depan ?? '') == 'berfungsi') ? 'checked' : '' }} />
                                <label class="btn btn-outline-success" for="ld">Berfungsi</label>

                                <input type="radio" class="btn-check" name="lampu_depan" value="tidak berfungsi" id="ld0" autocomplete="off"
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="lampusen_depan" value="berfungsi" id="lsd"
                                    {{ (old('lampusen_depan', $perjalanan->lampusen_depan ?? '') == 'berfungsi') ? 'checked' : '' }} autocomplete="off" />
                                <label class="btn btn-outline-success" for="lsd">Berfungsi</label>

                                <input type="radio" class="btn-check" name="lampusen_depan" value="tidak berfungsi" id="lsd0"
                                    {{ (old('lampusen_depan', $perjalanan->lampusen_depan ?? '') == 'tidak berfungsi') ? 'checked' : '' }} autocomplete="off" />
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="lampusen_belakang" value="berfungsi" id="lsb"
                                    {{ (old('lampusen_belakang', $perjalanan->lampusen_belakang ?? '') == 'berfungsi') ? 'checked' : '' }} autocomplete="off" />
                                <label class="btn btn-outline-success" for="lsb">Berfungsi</label>

                                <input type="radio" class="btn-check" name="lampusen_belakang" value="tidak berfungsi" id="lsb0"
                                    {{ (old('lampusen_belakang', $perjalanan->lampusen_belakang ?? '') == 'tidak berfungsi') ? 'checked' : '' }} autocomplete="off" />
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="lampu_rem" value="berfungsi"
                                    id="lr" autocomplete="off" {{ (old('lampu_rem', $perjalanan->lampu_rem ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="lampu_rem" value="tidak berfungsi"
                                    id="lr0" autocomplete="off" {{ (old('lampu_rem', $perjalanan->lampu_rem ?? '') == 'tidak berfungsi') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="lampu_mundur" value="berfungsi"
                                    id="lm" autocomplete="off" {{ (old('lampu_mundur', $perjalanan->lampu_mundur ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="lampu_mundur" value="tidak berfungsi"
                                    id="lm0" autocomplete="off" {{ (old('lampu_mundur', $perjalanan->lampu_mundur ?? '') == 'tidak berfungsi') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="klakson" value="baik" id="klak"
                                    autocomplete="off" {{ (old('klakson', $perjalanan->klakson ?? '') == 'baik') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="klakson" value="rusak" id="klak0"
                                    autocomplete="off" {{ (old('klakson', $perjalanan->klakson ?? '') == 'rusak') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="pedal_gas" value="berfungsi"
                                    id="pgas" autocomplete="off" {{ (old('pedal_gas', $perjalanan->pedal_gas ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="pedal_gas" value="rusak" id="pgas0"
                                    autocomplete="off" {{ (old('pedal_gas', $perjalanan->pedal_gas ?? '') == 'rusak') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="pedal_kopling" value="berfungsi"
                                    id="pkop" autocomplete="off" {{ (old('pedal_kopling', $perjalanan->pedal_kopling ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="pedal_kopling" value="rusak"
                                    id="pkop0" autocomplete="off" {{ (old('pedal_kopling', $perjalanan->pedal_kopling ?? '') == 'rusak') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="pedal_rem" value="berfungsi"
                                    id="prem" autocomplete="off" {{ (old('pedal_rem', $perjalanan->pedal_rem ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="pedal_rem" value="rusak" id="prem0"
                                    autocomplete="off" {{ (old('pedal_rem', $perjalanan->pedal_rem ?? '') == 'rusak') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="weaper" value="berfungsi" id="weap"
                                    autocomplete="off" {{ (old('weaper', $perjalanan->weaper ?? '') == 'berfungsi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="weaper" value="rusak" id="weap0"
                                    autocomplete="off" {{ (old('weaper', $perjalanan->weaper ?? '') == 'rusak') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="air_weaper" value="terisi" id="airw"
                                    autocomplete="off" {{ (old('air_weaper', $perjalanan->air_weaper ?? '') == 'terisi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="air_weaper" value="tidak terisi"
                                    id="airw0" autocomplete="off" {{ (old('air_weaper', $perjalanan->air_weaper ?? '') == 'tidak terisi') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="air_radiator" value="terisi"
                                    id="airr" autocomplete="off" {{ (old('air_radiator', $perjalanan->air_radiator ?? '') == 'terisi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="air_radiator" value="tidak terisi"
                                    id="airr0" autocomplete="off" {{ (old('air_radiator', $perjalanan->air_radiator ?? '') == 'tidak terisi') ? 'checked' : '' }}/>
                        ...
                        <div class="row p-2 mt-4">
                            ...
                            <div class="col-lg-8 col-sm-10 btn-group">
                                <input type="radio" class="btn-check" name="oli_mesin" value="terisi" id="oli"
                                    autocomplete="off" {{ (old('oli_mesin', $perjalanan->oli_mesin ?? '') == 'terisi') ? 'checked' : '' }}/>
                                ...
                                <input type="radio" class="btn-check" name="oli_mesin" value="tidak terisi"
                                    id="oli0" autocomplete="off" {{ (old('oli_mesin', $perjalanan->oli_mesin ?? '') == 'tidak terisi') ? 'checked' : '' }}/>
                        ...
                        @if (isset($perjalanan) && $perjalanan->photo_km_awal)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $perjalanan->photo_km_awal) }}" alt="Foto KM Awal" class="img-fluid" style="max-height: 200px;">
                            </div>
                        @endif
