            ...
            <form action="{{ route('acount.update', $user->id) }}" method="POST">
                ...
                <div class="modal-body mx-3">
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" id="defaultForm-name" class="form-control validate" placeholder="Input nama"
                                value="{{ $user->name }}">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="email" name="email" id="defaultForm-email" class="form-control validate" placeholder="Input email"
                                value="{{ $user->email }}">
                        </div>
