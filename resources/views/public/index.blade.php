                    ...
                    <div class="carousel-item">
                        <div class="row">
                            <div class="col-lg-5 col-sm-12">
                                ...
                                <p class="fs-10 fw-medium mb-4 pb-2">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, ipsa Autem
                                    dolorem mollitia culpa! Unde vel quos, perspiciatis sequi enim nemo. Quasi, deleniti
                                    tenetur ratione adipisci nobis ea laudantium id.
                                </p>
                            </div>
                            <div class="col-lg-7 col-sm-12">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 col-sm-12 pt-4" style="min-height: 500px;">
                        <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                            <img class="position-absolute img-fluid w-100 h-120" src="img/About Us.png"
        ...
        <div class="container align-items-center ms-auto">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/STAF 1.webp" alt=""
                                style="width: 400px; height: 400px;">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold text-center mb-0">Pengemudi Dengan Pencapaian Kilometer Terbanyak
                                </h5>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/STAF 2.jpg" alt=""
                                style="width: 400px; height: 400px;">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-content">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/STAF 3.jpg" alt=""
                                style="width: 400px; height: 400px;">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                    ...
                    <ul class="fa-ul" style="margin-left: 1.65em;">
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Jl. Sam
                                Ratulangi No.15 Penegahan Raya, Kedaton, Bandar Lampung 35112</span>
                        </li>
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-envelope"></i></span><span
                                class="ms-2">07217626359</span>
                        </li>
                        <li class="mb-3">
                    ...
                    <div class="mt-4 align-center">
                        <!-- Facebook -->
                        <a type="button" class="btn rounded-circle btn-floating btn-light btn-lg mx-2"><i
