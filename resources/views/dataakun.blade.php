            ...
            <div class="col-lg-3 col-sm-12">
                <div class="float-right">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body mx-3">
                                    <div class="mb-5">
                                        ...
                                        <input type="email" id="defaultForm-email" class="form-control validate" placeholder="example@gmail.com">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <i class="iconify mr-3" data-icon="carbon:user-role"></i>
                    ...
                    <div class="text-center">
                        <a href="" class="btn btn-primary btn-rounded mb-4" data-toggle="modal" data-target="#modalLoginForm"><i class="iconify nav-icon mr-3" data-icon="line-md:account-add"></i>Tambahkan Akun</a>
                    </div>
                    <!-- /button modal -->
                </div>
            </div>
