                                ...
                                <form action="{{ route('kendaraan.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body mx-3">
                                        <div class="mb-5">
                                            ...
                                            <input type="text" id="defaultForm-tipe" name="type" class="form-control validate" placeholder="contoh : Toyota || Avanza">
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" id="defaultForm-nopol" name="no_polisi" class="form-control validate" placeholder="BE-XXXX-XX">
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="date" id="defaultForm-tgl" name="tgl_masuk" class="form-control validate">
                                        </div>

                                        <div class="mb-4">
                                            <i class="iconify nav-icon mr-3" data-icon="tabler:photo-plus"></i>
                                            <label data-error="wrong" data-success="right" for="defaultForm-foto">Foto Kendaraan :</label>
                                            <input type="file" id="defaultForm-foto" name="photo" class="form-control-file">
                                        </div>
                                    </div>
        ...
        <table class="table table-striped text-center" id="tablecar">
            ...
            <tr>
                ...
                <td>
                    @if ($kendaraan->photo)
                    <!-- Modal -->
                    <div class="modal fade" id="modalLihat{{ $kendaraan->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header text-start">
                                ...
                                <div class="modal-body mx-3">
                                    <div class="mb-0">
                                        <img src="{{ asset('storage/' . $kendaraan->photo) }}" class="img-fluid" alt="Foto Kendaraan"/>
                                    </div>
                                </div>
                    ...
                    <!-- Button Modal -->
                    <div class="text-center">
                        <a href="#" class="btn btn-primary btn-rounded mb-4" data-toggle="modal" data-target="#modalLihat{{ $kendaraan->id }}"><i class="iconify nav-icon mr-3" data-icon="mdi:eye"></i>Lihat Foto</a>
                    </div>
                    <!-- /button modal -->
                    @else
                ...
                <td>
                    <a href="{{ route('kendaraan.edit', $kendaraan->id) }}" class="btn btn-primary"><i class="iconify" data-icon="material-symbols:edit"></i></a>
                    <form action="{{ route('kendaraan.destroy', $kendaraan->id) }}" method="POST" style="display: inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger"><i class="iconify" data-icon="material-symbols:delete"></i></button>
                    </form>
                </td>
            </tr>
            @endforeach
